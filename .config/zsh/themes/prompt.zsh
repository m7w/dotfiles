# Prompt
# Based on: Purification by Matthieu Cneude https://github.com/Phantas0s/purification
# Which in turn based on: Purity by Kevin Lanni https://github.com/therealklanni/purity
# MIT License
...
prompt_purification_setup() {
    ...
    PROMPT=$'%F{yellow}%n%f@%F{blue}%m%F{cyan}%~ $(prompt_dir_readonly)%F{red}|%B%F{cyan}➤%f%b '
}
